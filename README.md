...
The intent and purpose behind this project was to build a web app that takes an input from the user to display the weather. The program displays the temperature, if its rainy/cloudy/sunny, humidity, and wind speed.
